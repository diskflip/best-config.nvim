...
require('lazy').setup({
  ...
  { 'pineapplegiant/spaceduck', name = 'spaceduck', lazy = false, priority = 1000, config = function() end },
  { 'cocopon/iceberg.vim', name = 'iceberg', lazy = false, priority = 1000, config = function() end },
  { 'rebelot/kanagawa.nvim', name = 'kanagawa', lazy = false, priority = 1000, config = function() end },
  { 'rmehri01/onenord.nvim', name = 'onenord', lazy = false, priority = 1000, config = function() end },
  { 'yorumicolors/yorumi.nvim', name = 'yorumi', lazy = false, priority = 1000, config = function() end },
  { 'mellow-theme/mellow.nvim', name = 'mellow', lazy = false, priority = 1000, config = function() end },
  { 'vague2k/vague.nvim', name = 'vague', lazy = false, priority = 1000, config = function() end },
  {
  ...
  {
    'jwi5433/spearmint.nvim',
    name = 'spearmint',
    lazy = false,
    priority = 1000,
    config = function() end,
  },
  { 'uloco/bluloco.nvim', name = 'bluloco', lazy = false, priority = 1000, dependencies = { 'rktjmp/lush.nvim' }, config = function() end },
  {
  ...
  },
  {
    ...
    opts = {
      ...
      indent = { enable = true, disable = { 'ruby', 'javascript', 'typescript', 'javascriptreact', 'typescriptreact' } },
    },
  },
  {
...
vim.api.nvim_create_autocmd('ColorScheme', {
  ...
  callback = function()
    ...
    -- Override Git status highlight groups to prevent orange highlighting
